            ...
            <div class="card">
                <div class="card-header">
                    <h4>Edit & Update Level
                        <a href="{{ url('admin/levels') }}" class="btn btn-danger float-end" style="float: right; background-color:#005450;border:#005450 1px solid;">BACK</a>
                    </h4>
                </div>
                ...
                <div class="row">         
                        ...
                        <div class="form-group mb-3">
                            <button type="submit" class="btn btn-primary" style="margin-left: 20px; background-color:#005450;border:#005450 1px solid;">Update Levels</button>
                        </div>
            </div>
        </div>
    </div>

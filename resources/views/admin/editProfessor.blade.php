        ...
        @if ( Session::get('success'))
            ...
            <div class="card">
                <div class="card-header">
                    <h4>Edit & Update Professor
                        <a href="{{ url('admin/totalTeacher') }}" class="btn btn-danger float-end" style="float: right; background-color:#005450;border:#005450 1px solid;">BACK</a>
                    </h4>
                </div>
                <div class="card-body">
            <div class="row">

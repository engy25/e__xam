...
<head>
    ...
    <link href="{{ asset('http://netdna.bootstrapcdn.com/bootstrap/4.0.0-beta/css/bootstrap.min.css') }}"
          rel="stylesheet">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <h4>Edit & Update Subject
                                    <a href="{{ url('doctor/chapters') }}" class="btn btn-danger float-end" style="position: relative;left: 760px">BACK</a>
                                </h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
